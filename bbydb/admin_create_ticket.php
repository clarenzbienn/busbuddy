    ...
    <script>
        ...
        function updateFareAndSeats() {
            ...
            if (serviceClass === "Regular") {
                ...
                availableSeatsField.value = 45; // Set available seats for Regular
    ...
    <div class="content">
        ...
        <div id="reserved-seats-page" class="page" style="display:none;">
            ...
            <table>
                ...
                <?php while ($reservedRow = $reservedSeatsResult->fetch_assoc()): ?>
                <tr>
                    <td><?php echo htmlspecialchars($reservedRow['bus_number']); ?></td>
                    <td><?php echo htmlspecialchars($reservedRow['seat']); ?></td> <!-- Display concatenated seats -->
                    <td><?php echo htmlspecialchars($reservedRow['user_id']); ?></td>
                    <td><?php echo htmlspecialchars($reservedRow['created_at']); ?></td>
                    <td><?php echo htmlspecialchars($reservedRow['terminal']); ?></td>
                    <td><?php echo htmlspecialchars($reservedRow['destination']); ?></td>
                    <td><?php echo htmlspecialchars($reservedRow['service_class']); ?></td>
                    <td>₱ <?php echo htmlspecialchars($reservedRow['base_fare']); ?></td>
                </tr>
                <?php endwhile; ?>
            </table>
        </div>
